    ...
    <div>
      <h2 className="text-2xl font-bold mb-4">記事一覧</h2>
        <div className="flex flex-wrap gap-4">
          {data.map((item, index) => (
            <div key={index} className="card bg-white shadow-md overflow-hidden">
              <Image src={item.thumbnail} alt={item.title} width={400} height={300} loading="eager" />
              <div className="p-4">
                <h3 className="text-lg font-semibold mb-2">{item.title}</h3>
                <p className="text-gray-600 text-sm mb-2">{item.date}</p>
                <a href={item.url} className="text-blue-500 hover:underline">記事を読む</a>
              </div>
            </div>
          ))}
        </div>
